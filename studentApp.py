...
score=st.number_input("Enter the student's past academic scores",value=0,placeholder=" ")
sleep_hour=st.number_input('How many hours does the student sleep per day?')
