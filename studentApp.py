...
Hour_studied=st.number_input('How many hours did the student study per day?',value=None,min_value=0,max_value=24,palceholder=" ")
score=st.number_input("Enter the student's past academic scores",value=None)
...
eca=st.selectbox('Has the student been involved in any extracurricular activities?',('Yes',"No"),placeholder="Select Option")
